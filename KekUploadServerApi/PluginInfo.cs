...
public class PluginInfo
{
    ...
    /// </summary>
    /// <remarks>
    ///     The plugin names are case-sensitive and should be the same as the <see cref="Name" /> property of the plugins
    ///     <see cref="PluginInfo" /> class. If no dependencies are required, set this property to
    ...
    /// <remarks>
    ///     The plugin names are case-sensitive and should be the same as the <see cref="Name" /> property of the plugins
    ///     <see cref="PluginInfo" /> class. If no optional dependencies are needed, set this property to
    ///     <see cref="Array.Empty{T}" />.
    /// </remarks>
    /// <example>new []{"MyOtherPlugin"} or Array.Empty&lt;string&gt;()</example>
    ...
    /// <remarks>
    ///     The plugin names are case-sensitive and should be the same as the <see cref="Name" /> property of the plugins
    ///     <see cref="PluginInfo" /> class. If no plugins should be loaded before this plugin, set this property to
    ///     <see cref="Array.Empty{T}" />.
    /// </remarks>
    ...
    /// <remarks>
    ///     The plugin names are case-sensitive and should be the same as the <see cref="Name" /> property of the plugins
    ///     <see cref="PluginInfo" /> class. If no plugins should be loaded after this plugin, set this property to
    ///     <see cref="Array.Empty{T}" />.
    /// </remarks>
