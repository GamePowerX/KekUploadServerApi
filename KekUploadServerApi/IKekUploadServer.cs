...
public interface IKekUploadServer
{
    ...
    /// <remarks>The plugin name is case-sensitive and should be the same as the <see cref="PluginInfo.Name"/> property of the plugins <see cref="PluginInfo"/> class.</remarks>
    ...
    /// <param name="requestBody">The request body to upload.</param>
    /// <param name="hash">The hash of the chunk.</param>
    /// <remarks>The server converts the <paramref name="requestBody"/> to a <see cref="byte"/> array using <see cref="System.Text.Encoding.UTF8"/>.</remarks>
    Task<bool> UploadChunk(string streamId, string requestBody, string? hash = null);
    /// <summary>
    /// This method uploads a chunk to an upload stream with a <see cref="string"/> as the request body using the specified encoding.
    /// </summary>
    /// <param name="streamId">The id of the upload stream to upload the chunk to.</param>
    /// <param name="requestBody">The request body to upload.</param>
    /// <param name="encoding">The encoding to use to convert the <paramref name="requestBody"/> to a <see cref="byte"/> array.</param>
    /// <param name="hash">The hash of the chunk.</param>
    /// <remarks>The server converts the <paramref name="requestBody"/> to a <see cref="byte"/> array using the specified <paramref name="encoding"/>.</remarks>
    ...
    /// <remarks>This method should only be used for small files, as it loads the whole file into memory. For large files, use <see cref="GetUploadedFileStream"/> instead.</remarks>
    ...
    /// <remarks>This method should only be used for small files, as it loads the whole file into memory. For large files, use <see cref="GetUploadedFileStream"/> instead. And the server converts the bytes to a string using <see cref="System.Text.Encoding.UTF8"/>.</remarks>
    ...
    /// <returns>The string for the uploaded file or <c>null</c> if no uploaded file with the specified id exists.</returns>
    /// <remarks>This method should only be used for small files, as it loads the whole file into memory. For large files, use <see cref="GetUploadedFileStream"/> instead. And the server converts the bytes to a string using the specified <paramref name="encoding"/>.</remarks>
